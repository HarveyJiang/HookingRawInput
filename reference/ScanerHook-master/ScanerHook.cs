    ...
    public class ScanerHook
    {
        ...
        public bool Start()
        {
            if (hKeyboardHook == 0)
            {
                ...
                hKeyboardHook = SetWindowsHookEx(13, hookproc, mar, 0);
            }
        ...
        public class ScanerCodes
        {
            ...
            public void Add2(EventMsg msg)
            {
                var VirtKey = msg.message & 0xff;//虚拟吗
                var ScanCode = msg.paramL & 0xff;//扫描码
                var r = KeyCodeToUnicode(VirtKey, ScanCode);
                _result.Add(r);
            }
