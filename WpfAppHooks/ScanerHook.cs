...
namespace BarcodeScanner
{
    public class ScanerHook
    {
        ...
        public bool Start(IntPtr handler)
        {
            if (hKeyboardHook == 0)
            {
                ...
                hKeyboardHook = SetWindowsHookEx(13, hookproc, IntPtr.Zero, 0);
            }
        ...
        private int KeyboardHookProc(int nCode, Int32 wParam, IntPtr lParam)
        {
            ...
            codes.Add(msg);
            Log(new { order = "SetWindowsHookEx", exlparam = lParam, wparam = wParam, msg.paramL, msg.paramH,msg.hwnd });
        ...
        {
            private int ts = 100; // 指定输入间隔为100毫秒以内时为连续输入  
